\begin{titlepage}
	...
	\title{\vspace*{-70pt}
		...
		\vspace*{20pt}
		Un Estudio sobre
		Problema Prueba para Evaluar la Calidad de los Algoritmos %\footnote{Proyecto Nacional de Ciencias Básicas: PN223H010-005 Desarrollo de modelos y métodos matemáticos para la toma de decisiones.}
		\vspace*{-35pt}
