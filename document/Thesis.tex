...
\date{ 10 de febrero de 2025 \\\vspace{0.25cm}\href{https://github.com/FVSB/Tesis}{github.com/FVSB/Tesis}}
...
\newenvironment{resultstablee}[1]{
    \renewcommand{\arraystretch}{2.5} % Aumenta el espacio entre filas
    \begin{table}[H]
        \centering
        \caption{#1}
        \begin{adjustbox}{max width=\textwidth}
        ...
        \begin{tabular}{|l|l|l|l|l|l|l|l|l|}
            \hline
            \textbf{\Huge Nombre del problema}  & \textbf{ \Huge Punto estacionario}  & \textbf{\Huge Valor objetivo del punto estacionario} & \textbf{\Huge Punto óptimo} & \textbf{\Huge Valor del punto óptimo} & \textbf{\Huge Método seleccionado}& \textbf{\Huge Estatus Primal} & \textbf{\Huge Estatus Terminación} & \textbf{\Huge Tiempo Promedio} \\
            \hline
}{
        \end{tabular}
        \end{adjustbox}
