...
@objective(model,Min,x - y + -0.12x +-2.12y)
...
# Definir KKT
        ...
        # Make KKT
         ...
         @NLconstraint(model,-x^3 + 1.00*x*y+(l_1*(0))+(l_2*(0))==0)  
...
make_experiment(model,[ x ],[ y ],"Reformulacion_KKT","MitsosBarton2006Ex313_M-Estacionario")
